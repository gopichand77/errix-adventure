...
public class Player : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (CrossPlatformInputManager.GetButtonDown("Jump") && rb.velocity.y > -0.1 && rb.velocity.y < 0.1)
        {
...
//         verticalMove = SimpleInput.GetAxisRaw("Vertical");

//         // if(Input.GetButtonDown("Jump")){
//         //     jump = true;
//         //     CreateDust();
//         // }
//         // if(SimpleInput.GetAxisRaw("Vertical") == true){
//         //     jump = true;
//         //     CreateDust();
//         // }
//     }
